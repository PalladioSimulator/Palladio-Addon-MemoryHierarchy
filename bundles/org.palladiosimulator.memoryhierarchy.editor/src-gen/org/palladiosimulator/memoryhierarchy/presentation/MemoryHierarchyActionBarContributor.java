...
/**
 * This is the action bar contributor for the MemoryHierarchy model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class MemoryHierarchyActionBarContributor extends EditingDomainActionBarContributor
    ...
    protected IAction showPropertiesViewAction = new Action(
            MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                MemoryHierarchyActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction = new Action(
            MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return MemoryHierarchyActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (MemoryHierarchyActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) MemoryHierarchyActionBarContributor.this.activeEditorPart)
                    .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public MemoryHierarchyActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        ...
        toolBarManager.add(new Separator("memoryhierarchy-settings"));
        toolBarManager.add(new Separator("memoryhierarchy-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_MemoryHierarchyEditor_menu"),
                "org.palladiosimulator.memoryhierarchyMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(MemoryhierarchyEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
